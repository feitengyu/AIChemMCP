...
def high_flux_xrd_workstation_server_main_loop():
    ...
    for line in sys.stdin:
        try:
            ...
            print(json.dumps(response, ensure_ascii=False), flush=True)
            print(f"--- [high_flux_xrd_workstation_Server] Critical Error: {str(e)} ---", file=sys.stderr, flush=True)
...
def high_flux_xrd_workstation_server_advertise_capabilities():
    ...
    print(f"--- [high_flux_xrd_workstation_Server] 高通量平台-XRD工作站 is ready. ---", file=sys.stderr, flush=True)
