...
def magnetic_stirring_server_main_loop():
    ...
    for line in sys.stdin:
        try:
            ...
            print(json.dumps(response, ensure_ascii=False), flush=True)
            print(f"--- [magnetic_stirring_Server] Critical Error: {str(e)} ---", file=sys.stderr, flush=True)
...
def magnetic_stirring_server_advertise_capabilities():
    ...
    print(f"--- [magnetic_stirring_Server] 磁力搅拌工作站 is ready. ---", file=sys.stderr, flush=True)
