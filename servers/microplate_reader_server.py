...
from tools.microplate_reader_server_tools import ActionServerTools
...
def microplate_reader_server_main_loop():
    ...
    for line in sys.stdin:
        try:
            ...
            print(json.dumps(response, ensure_ascii=False), flush=True)
            print(f"--- [microplate_reader_Server] Critical Error: {str(e)} ---", file=sys.stderr, flush=True)
...
def microplate_reader_server_advertise_capabilities():
    ...
    "resultCode": {
        ...
        "description": "resultCode"
                ...
                "required": ["cmd", "others", "others.id", "others.modelName", "others.deviceId", "others.stacker"]
            }
        }
                    ]
                }
    ...
    print(f"--- [microplate_reader_Server] 酶标仪工作站 is ready. ---", file=sys.stderr, flush=True)
