...
def spraying_workstation_server_main_loop():
    ...
    for line in sys.stdin:
        try:
            ...
            print(json.dumps(response, ensure_ascii=False), flush=True)
            print(f"--- [spraying_workstation_Server] Critical Error: {str(e)} ---", file=sys.stderr, flush=True)
...
def spraying_workstation_server_advertise_capabilities():
    ...
    print(f"--- [spraying_workstation_Server] 喷涂工作站 is ready. ---", file=sys.stderr, flush=True)
