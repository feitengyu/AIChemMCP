"""
transfer_workstation 统一能力工作站工具类
设备名称: 转运工作站
设备描述: 擎朗机器人
...
class UnifiedWorkstationTools:
    ...
    def tool_transfer_workstation(self, task_description: str, **params):
        """
        转运工作站 - 擎朗机器人
        ...
        actions_list = [
    {
        ...
        "params": [
            ...
            },
            {
                ...
                "childParams": [],
                "constraintType": "ENUM",
                "constraintValue": "[{\"label\":\"303实验室\",\"value\":\"303\"},{\"label\":\"306实验室\",\"value\":\"306\"},{\"label\":\"122实验室\",\"value\":\"122\"}]",
                "constraintValueEn": "",
                "dataType": "string",
                "defaultValue": "",
                "elementDataType": null,
